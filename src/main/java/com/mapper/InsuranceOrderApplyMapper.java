...
@Mapper
public interface InsuranceOrderApplyMapper {
    /***分页查询初审对象*****/
    public List<InsuranceOrderApply> getOrderPreliminaryPageAll(@Param(value = "page") int page, @Param(value = "rows") int rows);
    /***查询初审总记录数*****/
    public int getMaxPreliminaryRows();
    /***分页查询复审对象*****/
    public List<InsuranceOrderApply> getOrderReexaminePageAll(@Param(value = "page") int page, @Param(value = "rows") int rows);
    /***查询复审总记录数*****/
